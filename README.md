...
- `bin/teatime/`: Core application package (modularized in #95 / rolled into kcresonance via #108):

- `bin/teatime/core.py`: Application constants, config paths, and shared helpers.

- `bin/teatime/app.py`: Main GTK application logic and UI (kcresonance-specific flow).

- `bin/teatime/stats.py`: Kcresonance stats engine and statistics window.
