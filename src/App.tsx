...
import { Timer, BarChart3, TrendingUp, User } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-[#f7f9ff] text-[#171c22] font-sans pb-32">
      <header className="sticky top-0 z-50 bg-[#f7f9ff]/80 backdrop-blur-md px-6 py-4 flex items-center justify-between">
        <h1 className="text-xl font-black tracking-tight">Your Steeps</h1>
      </header>
      <main className="px-6 pt-8">
        <p className="text-[#424753]">Session history coming soon...</p>
      </main>
    </div>
  );
}
...
function StatsView() {
  return (
    <div className="min-h-screen bg-[#f7f9ff] text-[#171c22] font-sans pb-32">
      <header className="sticky top-0 z-50 bg-[#f7f9ff]/80 backdrop-blur-md px-6 py-4 flex items-center justify-between">
        <h1 className="text-xl font-black tracking-tight">Statistics</h1>
      </header>
      <main className="px-6 pt-8">
        <p className="text-[#424753]">Stats coming soon...</p>
      </main>
    </div>
  );
}
