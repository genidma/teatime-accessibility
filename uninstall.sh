...
echo ""
echo "Note: If you created a desktop shortcut, you may need to refresh your desktop"
echo "      or log out and back in for the icon to be removed from the desktop view."
echo ""
